...
```bash
# 更新到最新版本（main 分支）
uv tool install --from git+https://github.com/Wulnut/feishu_agent lark-agent --force

# 更新到特定版本/tag（例如 v0.0.2）
uv tool install --from git+https://github.com/Wulnut/feishu_agent@v0.0.2 lark-agent --force
