...
class WorkItemAPI:
    ...
    async def get_project_fields(
        self, project_key: str, work_item_type_key: Optional[str] = None
    ) -> BaseResponse[List[FieldDefinition]]:
        """
        Retrieve all field definitions for a project.
        ...
        return BaseResponse[List[FieldDefinition]].model_validate(resp.json())
    ...
    async def create_work_item(
        ...
        field_value_pairs: Optional[List[Dict[str, Any]]] = None,
    ) -> BaseResponse[int]:
        """
